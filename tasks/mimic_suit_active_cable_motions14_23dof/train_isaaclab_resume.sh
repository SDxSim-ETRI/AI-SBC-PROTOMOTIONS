#!/usr/bin/env bash
# mimic_suit_active_cable_motions14_23dof — IsaacLab active cable 학습 (14모션)
#
# 학습 정보:
...
#   warm_start: output_isaaclab/last.ckpt (Newton→IsaacLab sim-to-sim)
#
# 재시작 (resume):
...
#   bash tasks/mimic_suit_active_cable_motions14_23dof/train_isaaclab_resume.sh
...
$PYTHON protomotions/train_agent.py \
    ...
    --num-envs 4096 \
    --batch-size 16384 \
    --checkpoint tasks/mimic_suit_active_cable_motions14_23dof/output_isaaclab/last.ckpt
