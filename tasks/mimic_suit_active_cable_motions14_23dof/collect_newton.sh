#!/usr/bin/env bash
# mimic_suit_active_cable_motions14_23dof — Newton 데이터 수집 (케이블 필드 포함)
#
# 출력: data/collected/active_cable_newton_<timestamp>.zarr
#
# 실행:
#   cd /home/user/ProtoMotions
#   bash tasks/mimic_suit_active_cable_motions14_23dof/collect_newton.sh
#   bash tasks/mimic_suit_active_cable_motions14_23dof/collect_newton.sh output_newton/score_based.ckpt
...
OUTPUT="data/collected/active_cable_newton_${TIMESTAMP}.zarr"
