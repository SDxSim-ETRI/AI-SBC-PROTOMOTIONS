#!/usr/bin/env bash
# mimic_suit_active_cable_motions14_23dof — Newton 재학습 (failure_discount=0.3)
#
# 학습 정보:
#   robot    : skeleton_torque_suit_active_cable (27-DOF, active cable, DOFC A버전)
...
#   bash tasks/mimic_suit_active_cable_motions14_23dof/train_newton_fd03.sh
...
$PYTHON protomotions/train_agent.py \
    ...
    --simulator newton \
    --experiment-path examples/experiments/mimic_newton_active_cable/mlp_motions14_active_cable_newton.py \
    --experiment-name mimic_suit_active_cable_motions14_23dof \
    --save-dir tasks/mimic_suit_active_cable_motions14_23dof/output_newton_fd03 \
