#!/usr/bin/env bash
# mimic_suit_passive_cable_motions14_23dof — IsaacLab USD mesh 자동 녹화 (14모션 × 20초)
# 제외 모션: 02-constspeed_reduced_humanoid (motions_11+koo_4 → 11+koo_3)
#
# 녹화 설정:
#   record-steps 5600 = 280초 (14모션 × 20초)
#   cycle-seconds 20  = 모션당 20초
#
# 출력: tasks/mimic_suit_passive_cable_motions14_23dof/recordings/<ckpt>-<datetime>/
#
...
#   bash tasks/mimic_suit_passive_cable_motions14_23dof/record_isaaclab.sh output_isaaclab/last.ckpt
...
RECORDINGS_DIR="tasks/mimic_suit_passive_cable_motions14_23dof/recordings"
