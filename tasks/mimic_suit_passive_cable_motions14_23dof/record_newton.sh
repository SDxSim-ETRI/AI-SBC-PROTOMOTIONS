#!/usr/bin/env bash
# mimic_suit_passive_cable_motions14_23dof — Newton mesh 자동 녹화 (14모션 × 20초)
...
#   bash tasks/mimic_suit_passive_cable_motions14_23dof/record_newton.sh output_newton/last.ckpt
