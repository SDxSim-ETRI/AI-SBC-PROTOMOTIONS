#!/usr/bin/env bash
# mimic_suit_passive_cable_motions14_23dof — IsaacLab USD mesh 시각화 인터랙티브 재생
#
...
#   bash tasks/mimic_suit_passive_cable_motions14_23dof/play_isaaclab.sh output_isaaclab/score_based.ckpt
...
CHECKPOINT="${1:-tasks/mimic_suit_passive_cable_motions14_23dof/output_isaaclab/last.ckpt}"
